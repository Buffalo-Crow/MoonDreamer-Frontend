...
var Input = React.memo(function (props) {
    var _a = props, onInputChangedEnd = _a.onInputChangedEnd, onChangedDelayed = _a.onChangedDelayed, onChangedValue = _a.onChangedValue, delayMs = _a.delayMs, testID = _a.testID, restProps = __rest(_a, ["onInputChangedEnd", "onChangedDelayed", "onChangedValue", "delayMs", "testID"]);
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        onInputChangedEnd && (React__default["default"].createElement("input", __assign({ "data-testid": testID }, restProps, { className: restProps === null || restProps === void 0 ? void 0 : restProps.className, style: restProps.style, value: props.value, onChange: changeValue, onBlur: function (e) {
                onInputChangedEnd(e.target.value);
            }, onKeyDown: function (e) {
                if (e.key == 'Enter')
                    onInputChangedEnd(state);
            } }))),
        !onInputChangedEnd && (React__default["default"].createElement("input", __assign({ "data-testid": testID }, restProps, { className: restProps === null || restProps === void 0 ? void 0 : restProps.className, style: restProps.style, value: props.value, onChange: changeValue })))));
});
...
var BasicFilter = React.memo(function (_a) {
    ...
    return (React__default["default"].createElement("div", null,
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: 'item-panel', "data-testid": 'contrast-label' }, labels['Contrast']),
            React__default["default"].createElement("p", { className: 'item-panel', "data-testid": 'contrast-value' }, (+state.contrast).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { testID: 'contrast', id: 'contrast', name: 'contrast', className: 'input-range', onChangedDelayed: onUpdateContrast, delayMs: 100, onChangedValue: function (value) {
                    setState(__assign(__assign({}, state), { contrast: value }));
                }, style: {
                    maxWidth: '100%',
                    width: '100%',
                    color: color
        ...
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: 'item-panel', "data-testid": 'brightness-label' }, labels['Brightness']),
            React__default["default"].createElement("p", { className: 'item-panel', "data-testid": 'brightness-value' }, (+state.brightness).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { testID: 'brightness', id: 'brightness', name: 'brightness', className: 'input-range', onChangedDelayed: onUpdateBrightness, onChangedValue: function (value) {
                    setState(__assign(__assign({}, state), { brightness: value }));
                }, style: {
                    maxWidth: '100%',
                    width: '100%',
                    color: color
        ...
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { testID: 'grayscale', id: 'grayscale', name: 'grayscale', className: 'input-range', onChangedDelayed: onUpdateGrayscale, delayMs: 100, onChangedValue: function (value) {
                    setState(__assign(__assign({}, state), { grayscale: value }));
                }, style: {
                    maxWidth: '100%',
                    width: '100%',
                    color: color
        ...
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            ...
            React__default["default"].createElement("p", { className: 'item-panel', "data-testid": 'grayscale-value' }, (+state.saturate).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: 'input-range', onChangedDelayed: onUpdateSaturate, onChangedValue: function (value) {
                    setState(__assign(__assign({}, state), { saturate: value }));
                }, style: {
                    maxWidth: '100%',
                    width: '100%',
                    color: color
        ...
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: 'input-range', onChangedDelayed: onUpdateSepia, onChangedValue: function (value) {
                    setState(__assign(__assign({}, state), { sepia: value }));
                }, style: {
                    maxWidth: '100%',
                    width: '100%',
                    color: color
        ...
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: 'input-range', onChangedDelayed: onUpdateBlur, onChangedValue: function (value) {
                    setState(__assign(__assign({}, state), { blur: value }));
                }, style: {
                    maxWidth: '100%',
                    width: '100%',
                    color: color
...
var EditImage = React.memo(function (_a) {
    ...
    var _o = React.useState(0), rotation = _o[0], setRotation = _o[1];
    ...
    function onRotate(angle) {
        var newRotation = (rotation + angle + 360) % 360;
        setRotation(newRotation);
        applyChanges(__assign(__assign({}, state), { rotation: newRotation }), false);
    }
                        ...
                        React__default["default"].createElement(TabItem, { name: labels['Basic'] },
                            ...
                            React__default["default"].createElement("div", { className: 'flex-row-start', style: { marginTop: '5px', justifyContent: 'space-between' } },
                                React__default["default"].createElement("span", { style: { display: 'flex', alignItems: 'center', gap: '.5rem' } },
                                    React__default["default"].createElement("button", { disabled: showCrop, onClick: function () { return onRotate(-90); }, className: 'icon-btn' },
                                        React__default["default"].createElement("span", { className: 'material-icons' }, "rotate_left")),
                                    React__default["default"].createElement("button", { disabled: showCrop, onClick: function () { return onRotate(90); }, className: 'icon-btn' },
                                        React__default["default"].createElement("span", { className: 'material-icons' }, "rotate_right"))),
                                React__default["default"].createElement("span", { style: { display: 'flex', alignItems: 'center', gap: '.5rem' } },
                                    React__default["default"].createElement("input", { "data-testid": "set-crop-checkbox", name: "set-crop", type: 'checkbox', onChange: function (e) {
