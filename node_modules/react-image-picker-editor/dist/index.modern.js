...
var Input = memo(function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        onInputChangedEnd && (React.createElement("input", __assign({ "data-testid": testID }, restProps, { className: restProps === null || restProps === void 0 ? void 0 : restProps.className, style: restProps.style, value: props.value, onChange: changeValue, onBlur: function (e) {
                onInputChangedEnd(e.target.value);
            }, onKeyDown: function (e) {
                if (e.key == 'Enter')
                    onInputChangedEnd(state);
            } }))),
        !onInputChangedEnd && (React.createElement("input", __assign({ "data-testid": testID }, restProps, { className: restProps === null || restProps === void 0 ? void 0 : restProps.className, style: restProps.style, value: props.value, onChange: changeValue })))));
});
...
var BasicFilter = memo(function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React.createElement("p", { className: 'item-panel', "data-testid": 'contrast-label' }, labels['Contrast']),
            React.createElement("p", { className: 'item-panel', "data-testid": 'contrast-value' }, (+state.contrast).toFixed(2))),
        React.createElement("div", { className: 'flex-row-start' },
            React.createElement(Input, { testID: 'contrast', id: 'contrast', name: 'contrast', className: 'input-range', onChangedDelayed: onUpdateContrast, delayMs: 100, onChangedValue: function (value) {
        ...
        React.createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React.createElement("p", { className: 'item-panel', "data-testid": 'brightness-label' }, labels['Brightness']),
            React.createElement("p", { className: 'item-panel', "data-testid": 'brightness-value' }, (+state.brightness).toFixed(2))),
        React.createElement("div", { className: 'flex-row-start' },
            React.createElement(Input, { testID: 'brightness', id: 'brightness', name: 'brightness', className: 'input-range', onChangedDelayed: onUpdateBrightness, onChangedValue: function (value) {
        ...
        React.createElement("div", { className: 'flex-row-start' },
            React.createElement(Input, { testID: 'grayscale', id: 'grayscale', name: 'grayscale', className: 'input-range', onChangedDelayed: onUpdateGrayscale, delayMs: 100, onChangedValue: function (value) {
        ...
        React.createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            ...
            React.createElement("p", { className: 'item-panel', "data-testid": 'grayscale-value' }, (+state.saturate).toFixed(2))),
        React.createElement("div", { className: 'flex-row-start' },
            React.createElement(Input, { className: 'input-range', onChangedDelayed: onUpdateSaturate, onChangedValue: function (value) {
        ...
        React.createElement("div", { className: 'flex-row-start' },
            React.createElement(Input, { className: 'input-range', onChangedDelayed: onUpdateSepia, onChangedValue: function (value) {
        ...
        React.createElement("div", { className: 'flex-row-start' },
            React.createElement(Input, { className: 'input-range', onChangedDelayed: onUpdateBlur, onChangedValue: function (value) {
...
var EditImage = memo(function (_a) {
    ...
    var _o = useState(0), rotation = _o[0], setRotation = _o[1];
                        ...
                        React.createElement(TabItem, { name: labels['Basic'] },
                            ...
                            React.createElement("div", { className: 'flex-row-start', style: { marginTop: '5px', justifyContent: 'space-between' } },
                                React.createElement("span", { style: { display: 'flex', alignItems: 'center', gap: '.5rem' } },
                                    React.createElement("button", { disabled: showCrop, onClick: function () { return onRotate(-90); }, className: 'icon-btn' },
                                        React.createElement("span", { className: 'material-icons' }, "rotate_left")),
                                    React.createElement("button", { disabled: showCrop, onClick: function () { return onRotate(90); }, className: 'icon-btn' },
                                        React.createElement("span", { className: 'material-icons' }, "rotate_right"))),
                                React.createElement("span", { style: { display: 'flex', alignItems: 'center', gap: '.5rem' } },
                                    React.createElement("input", { "data-testid": "set-crop-checkbox", name: "set-crop", type: 'checkbox', onChange: function (e) {
